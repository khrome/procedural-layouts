...
exports.shuffle = exports.shift = exports.seedrandom = exports.seed = exports.resetGlobal = exports.range = exports.random = exports.elementWeighted = exports.element = exports.dice = exports.decide = void 0;
...
const random = () => {
  //simple Math.random() replacement
...
const shift = arr => {
  let res = arr.slice(0);
  return res.splice((void 0).range(0, res.length)).concat(res);
};
...
const elementWeighted = (collection, weights) => {
 ...
 */
exports.elementWeighted = elementWeighted;
const dice = (syntax, allowNegative = false) => {
