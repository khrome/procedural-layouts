...
exports.metroid = exports.Metroid = void 0;
...
class Metroid {
  ...
  build() {
    this.world = metroidGenerator(this.options);
    return this.world;
  }
}
exports.Metroid = Metroid;
const metroidGenerator = (config = {}) => {
...
const metroid = function (config) {
  var level = new Metroid(config);
  return level.build();
};
exports.metroid = metroid;